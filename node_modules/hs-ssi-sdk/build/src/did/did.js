...
class HypersignDID {
    ...
    register(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log('hihihi')
            console.log("signInfos", signInfos)

            // const url = 'https://api.entity.hypersign.id/api/v1/did/register';
            // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBJZCI6IjZhZTdlMDRkMmYwZmIyYjBiNzNjNTg1ZDU0Y2E4NWExNzA2YiIsInVzZXJJZCI6Im11c2ljYXQxMDIwQGdtYWlsLmNvbSIsImdyYW50VHlwZSI6ImNsaWVudF9jcmVkZW50aWFscyIsImlhdCI6MTY5MDMzNzI3NSwiZXhwIjoxNjkwMzUxNjc1fQ.vzbX53qzHlZ7PkeKGrWOoyxRwH5PcUwiJy2nh6Cif40";
            ...
            console.log("requestBody node...", JSON.stringify(requestBody, null, 2))
            return signInfos[0].signature
